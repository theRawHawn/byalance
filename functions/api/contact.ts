...
// IP Rate limiting memory store (in-memory map across the warm worker instance)
...
export async function onRequestPost(context: any) {
  try {
    ...
    if (message_subject) {
      console.warn('[Byalance] Honeypot triggered. Silent redirect/blackhole for robotic submission.');
