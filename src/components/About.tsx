...
// Import high-quality, compressed JPG slideshow assets
import slideOverall from '../assets/images/about_overall.jpg';
import slideAccounting from '../assets/images/about_accounting.jpg';
import slideGst from '../assets/images/about_gst.jpg';
import slideTds from '../assets/images/about_tds.jpg';
import slidePayroll from '../assets/images/about_payroll.jpg';
  ...
  te: {
    ...
    slides: [
      ...
      },
      {
        ...
        caption: "పీఎఫ్, ఈఎస్ఐ మరియు ప్రొఫెషనల్ టాక్స్ (PT) తో కూడిన పూర్తి పేరోల్ ప్రాసెసింగ్."
      }
    ],
    tooltips: {
      excellence: "శ్రేష్ఠత",
