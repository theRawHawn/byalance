...
export default function Contact() {
  ...
  const [formData, setFormData] = useState({
    ...
    businessType: '',
    message: '',
    message_subject: '', // Invisible honeypot field
  });
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20">
          ...
          >
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              {/* Anti-spam honeypot field - completely hidden from human users */}
              <div className="hidden sr-only absolute opacity-0 pointer-events-none" aria-hidden="true">
                <label htmlFor="message_subject">Do not fill this field if you are human</label>
                <input
                  id="message_subject"
                  type="text"
