...
export const translations = {
  ...
  hi: {
    ...
    hero: {
      subtitle: 'अनुपालन को सरल बनाना, विकास को सशक्त बनाना।',
  ...
  kn: {
    ...
    hero: {
      subtitle: 'ಅನುಸರಣೆಯನ್ನು ಸರಳಗೊಳಿಸುವುದು, ಬೆಳವಣಿಗೆಗೆ ಶಕ್ತಿ ನೀಡುವುದು.',
  ...
  te: {
    ...
    hero: {
      subtitle: 'సమ్మతిని సరళీకృతం చేయడం, వృద్ధిని పెంచడం.',
  ...
  mr: {
    ...
    hero: {
      subtitle: 'अनुपालन सुलभ करणे, विकासाला चालना देणे.',
  ...
  ta: {
    ...
    hero: {
      subtitle: 'இணக்கத்தை எளிதாக்குவது, வளர்ச்சியைத் தூண்டுவது.',
