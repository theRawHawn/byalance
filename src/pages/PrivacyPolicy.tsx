      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="bg-white shadow-lg rounded-lg p-8">
          <div className="prose lg:prose-xl prose-headings:text-blue-600 max-w-none">
            ...
            <p className="text-gray-700">
              Byalance is a Remote accounting and compliance services firm registered in India, providing bookkeeping, GST filing, TDS management, payroll processing, and ITR services to businesses across India.
            </p>
            <p className="text-gray-700">
            ...
            <ul className="list-disc list-inside text-gray-700">
              <li>All documents shared with us are stored on password-protected, encrypted secure storage</li>
